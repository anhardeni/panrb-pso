...
// $analisa =[];
// foreach ($chart7 as $chart71) {
// 	$analisa[] = $chart71["analisa"];
// }
// var_dump($analisa);
			...
			<div class="card card-danger">
				<div class="card-body">
					<div class="alert alert-info">
						...
						<a href="pso-master/index" class="btn btn-primary">TAHAP 02</a>
					</div>
				</div>
			</div>
		</div>
...
echo Highcharts::widget([
	...
	'options' => [
		...
		'title' => [
			'text' => 'Rekapitulasi ASN ',
		],
		'xAxis' => [
          //  'categories' => ['Apples', 'Oranges', 'Pears', 'Bananas', 'Plums', 'a2', 'a3'],
			// 'type'=> "category",
			// 'labels'=> [
   //    'step' => 1
   //  ],
